...
class PostOperativeSafetyController extends Controller
{
    ...
    public function store(Request $request, CaseReportForm $crf, PostOperativeData $postoperative)
    {
        ...
        return redirect()->route('crf.postoperative.safetyparameter.index', $storeParameters)->with(['message' => $message]);
    ...
    {
        $storeUri = 'crf.postoperative.safetyparameter.update';
        $opStoreUri = 'crf.postoperative.update';
        $storeParameters = [
            'crf' => $crf,
            'postoperative' => $postoperative,
        ...
        return view('casereportforms.FormFields.SafetyParameter.edit', compact('crf', 'storeUri',  'storeParameters', 'breadcrumb','safetyparameter'));
    }
    ...
    public function update(Request $request, CaseReportForm $crf, PostOperativeData $postoperative, SafetyParameter $safetyparameter)
    {
        ...
        return redirect()->route('crf.postoperative.index', $storeParameters)->with(['message' => $message]);
    }
