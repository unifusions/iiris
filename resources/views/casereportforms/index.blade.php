                                    ...
                                    @if ($caseReportForm->total() > 0)
                                        @foreach ($caseReportForm as $index => $crf)
                                            <tr class="align-middle">
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-even gap-2 align-items-center">
                                                            ...
                                                            @can('admin')
                                                                <form
                                                                    ...
                                                                    <button type="submit" type="submit"
                                                                        ...
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width=15 height=15 class="me-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
