<x-app-layout>
    ...
    @endphp
    @if (empty($mode->hasMedications))
        <div class="container">
            <form action="{{ route($opStoreUri, $storeParameters) }}" method="POST">
                @method('PUT')
                @csrf
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="card  shadow-sm rounded-5">
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        @foreach ($mode->medications as $medication)
                                            <tr>
                                                ...
                                                <form
                                                    action="{{ route($destroyUri, ['crf' => $crf, $breadcrumb['mode'] => $mode, 'medication' => $medication]) }}"
                                                    method="POST">
                                                    @method('DELETE')
                                                    @csrf
                                                    <td>
