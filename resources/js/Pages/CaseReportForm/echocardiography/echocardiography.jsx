...
import { RenderFieldEchoDatas, RenderDateFieldDatas, RenderDateFieldEchoDatas, RenderFieldEchoReviewDatas } from "../FormData/FormDataHelper";
import MarkasReviewed from "../FormData/MarkasReviewed";
...
export default function Echocardiography({ id, echodicomfiles, echocardiographies, role, createUrl, editUrl, enableActions, crf, preoperative, postoperative, scheduledvisit, unscheduledvisit }) {
    const options = {
        day: 'numeric',
        month: 'numeric',
        year: 'numeric'
